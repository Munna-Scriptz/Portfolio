...
const socials = [
    { label: 'Facebook', href: 'https://www.facebook.com/rexon.notfr', icon: FaFacebookF },
    { label: 'Instagram', href: 'https://www.instagram.com/rexon.notfr/?__pwa=1', icon: FaInstagram },
    { label: 'Twitter', href: 'https://github.com/Munna-Scriptz', icon: FaXTwitter },
    { label: 'Github', href: 'https://github.com/Munna-Scriptz', icon: FaGithub },
    { label: 'Linkedin', href: 'https://www.linkedin.com/in/munna-scriptz-25287635b/', icon: FaLinkedinIn },
]
