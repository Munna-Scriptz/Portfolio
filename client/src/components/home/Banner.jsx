        ...
        <div className="container">
          <div className='flex justify-between items-start md:flex-nowrap flex-wrap gap-10 lg:gap-0'>
            <div className="bannerText" >
              ...
              <h1 data-aos="fade-right" data-aos-duration="600" data-aos-delay="0" data-aos-easing="ease-out-cubic" className='font-poppins text-Primary text-[38px] lg:text-[68px] font-medium lg:mt-2 mt-4'>Hi, i'm <span className='text-[#BF4A1A]'>Munna</span></h1>
              {/* -----animated Text------- */}
