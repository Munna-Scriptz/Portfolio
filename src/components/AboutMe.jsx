            ...
            <div className="container">
                <div className="AboutMe flex lg:flex-row flex-col justify-between">
                    <div className="aboutMeText">
                        ...
                        <p className='lg:text-[68px] text-[40px] font-soldier lg:leading-[72px] text-Primary font-medium w-[370px]'>Creating Stuff That <span data-aos="fade-left" className='text-coffee'>Does More </span>Than Impress</p>
                        <div className='lg:text-[18px] text-[15px] font-poppins text-second font-normal lg:mt-10 lg:mb-0 mb-5 mt-5 w-[370px]'><BlurText text="Creative designer based in Melbourne" delay={250} animateBy="words" direction="top"/></div>
                    </div>
                    <div>
