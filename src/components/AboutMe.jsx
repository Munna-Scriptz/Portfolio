            ...
            <div className="container">
                <div className="AboutMe flex justify-between">
                    <div className="aboutMeText">
                        ...
                        <p className='text-[18px] font-poppins text-second font-normal mt-10 w-[370px]'><BlurText text="Creative designer based in Melbourne" delay={250} animateBy="words" direction="top"/></p>
                    </div>
                    <div>
                        ...
                        <div className='flex items-center justify-between w-[500px] mb-[50px]'>
                            ...
                            <div className='flex flex-col gap-4'>
                                ...
                                <p className='flex items-center gap-3 font-poppins font-medium'><FaCheck />Will power</p>
                            </div>
                        </div>
