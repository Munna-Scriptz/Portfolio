            ...
            <div id="Services-Row">
                ...
                <div>
                    ...
                    <div className='flex items-center justify-between'>
                        <h2 className='font-soldier text-Primary lg:text-[152px] text-[64px] font-medium uppercase'><ScrollFloat animationDuration={1} ease='back.inOut(2)' scrollStart='center bottom+=60%' scrollEnd='bottom bottom-=60%' stagger={0.03}>Services</ScrollFloat></h2>
