            ...
            <section className='md:pt-20 pt-25'>
                <div className="container">
                    <div className="header">
                        <div className='flex items-center justify-center font-poppins text-Primary font-medium lg:text-2xl text-lg'><ScrollFloat animationDuration={1} ease='back.inOut(2)' scrollStart='center bottom+=80%' scrollEnd='bottom bottom-=80%' stagger={0.03}>MY SKILLS</ScrollFloat></div>
                    ...
                    <div className='mt-20 lg:hidden grid md:grid-cols-6 grid-cols-3 justify-between gap-y-10 gap-x-5'>
